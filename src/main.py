...
tf.flags.DEFINE_bool('add_noise', False, 'boolean for adding salt & pepper noise to input image')
tf.flags.DEFINE_float('learning_rate', 1e-3, 'initial learning rate for Adam, default: 0.0001')
...
tf.flags.DEFINE_integer('print_freq', 100, 'print frequency for loss, default: 50')
tf.flags.DEFINE_integer('save_freq', 5000, 'save frequency for model, default: 5000')
tf.flags.DEFINE_integer('sample_freq', 500, 'sample frequency for saving image, default: 250')
